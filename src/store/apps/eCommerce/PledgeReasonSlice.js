...
export const PledgeReasonSlice = createSlice({
  name: 'ecommerce',
  initialState,
  reducers: {
    // HAS ERROR
...
export const {
  ...
  filterReset,
  sortByColor,
} = PledgeReasonSlice.actions;


export const fetchPledgeReason = () => async (dispatch) => {
  try {
...
export default PledgeReasonSlice.reducer;
