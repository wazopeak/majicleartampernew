...
const API_URL = 'http://172.20.10.8:2004/users/alluserpledge';
...
export const PledgeUserSlice = createSlice({
  name: 'ecommerce',
  initialState,
  reducers: {
    // HAS ERROR
...
export const {
  ...
  filterReset,
  sortByColor,
} = PledgeUserSlice.actions;


export const fetchPledgeUser = () => async (dispatch) => {
  try {
...
export default PledgeUserSlice.reducer;
