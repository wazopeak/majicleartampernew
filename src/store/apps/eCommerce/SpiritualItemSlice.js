...
const API_URL = 'http://172.20.10.8:2004/users/allspiritualitem';
...
export const SpiritualItemSlice = createSlice({
  name: 'ecommerce',
  initialState,
  reducers: {
    // HAS ERROR
...
export const {
  ...
  filterReset,
  sortByColor,
} = SpiritualItemSlice.actions;

export const fetchSpiritualItem = () => async (dispatch) => {
  try {
...
export default SpiritualItemSlice.reducer;
