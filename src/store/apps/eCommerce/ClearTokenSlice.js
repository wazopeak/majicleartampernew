...
const API_URL = '/users/allclearedtampertoken';
...
export const ClearTokenSlice = createSlice({
  name: 'ecommerce',
  initialState,
  reducers: {
    // HAS ERROR
...
export const {
  ...
  filterReset,
  sortByColor,
} = ClearTokenSlice.actions;


export const fetchClearToken = () => async (dispatch) => {
...
export default ClearTokenSlice.reducer;
