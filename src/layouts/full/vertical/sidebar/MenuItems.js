...
// read group id once (localStorage stored value)
...
// small helper to decide whether to show Users menu
const showUsersMenu = (groupId === 1 || groupId === 2);
...
const Menuitems = [
  ...
  // {
  //   id: uniqueId(),
  //   title: 'Angalia Tokeni',
  //   icon: IconBottle,
  //   href: '/tables/tokensearch',
  //   children: [
  //     {
  //       id: uniqueId(),
  //       title: 'Angalia Tokeni',
  ...
  //   ],
  // },
    // Conditionally include the Users menu only for group 1 or 2
  ...(
    showUsersMenu
      ? [
          {
  ...
  // },
  {
    ...
    children: [
      ...
      //   title: 'Pledge Reason',
      //   icon: IconPoint,
      //   href: '/tables/pledgereason',
      // },
      // {
      //   id: uniqueId(),
      //   title: 'User Pledge',
      //   icon: IconPoint,
      //   href: '/tables/pledgeuser',
      // },
    ],
  },
  // {
  ...
  //   title: 'Akaunti',
  //   icon: IconUserCircle,
  //   href: '/tables/accounts',
  //   children: [
  //     {
  //       id: uniqueId(),
  //       title: 'Orodha Ya Akaunti',
  //       icon: IconPoint,
  //       href: '/tables/accounts',
  //     },
  ...
  // },
  {
    ...
    children: [
      ...
      //   title: 'Futa Credit',
      //   icon: IconPoint,
      //   href: '/tables/clearcredit',
      // },
      {
        id: uniqueId(),
        title: 'Clear Tamper',
        icon: IconPoint,
        href: '/tables/cleartemper',
      },
      // {
      //   id: uniqueId(),
      //   title: 'Cleared Tamper Token',
      //   icon: IconPoint,
      //   href: '/tables/tokensearch',
      // },
